...
import com.neom108.SmartHire.entity.IRecruiterJobs;
...
public interface JobPostActivityRepository extends JpaRepository<JobPostActivity,Integer> {
    ...
    @Query(value = " SELECT COUNT(s.user_id) as totalCandidates,j.job_post_id,j.job_title,l.id as locationId,l.city,l.state,l.country,c.id as companyId,c.name FROM job_post_activity j " +
            ...
            " GROUP By j.job_post_id" ,nativeQuery = true) // native SQL query and not JPQL
    ...
    // retrieves jobs for a given recruiter id/ combines job post activity, job location, company
//    includes a count of candiates who applied for a given job
